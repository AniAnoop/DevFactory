    ...
    <>
      <div className="fr1">
        ...
        <div className="fr1_col2">
          ...
          <div>
            <button className="fr1_col2_b" onClick={(e)=>{navigate("/login") }}>Login</button>
          </div>
        </div>
      </div>
        ...
        <div className="fr2_main">
          ...
          <div className="fr2_row">
            <div className="fr2_div1">
              ...
              <select className="fr2_select" placeholder="select">
            ...
            <div className="fr2_div2">
              ...
              <input className="fr2_input1" placeholder="Name" value={nameValue} onChange={(e)=>setNameFunc(e.target.value)} />
            </div>
            <div className="fr2_div3">
              <label className="fr2_l4">Mobile Number</label>
              <input className="fr2_input2" placeholder=" Mobile Number" value={mobNumber} onChange={(e)=>setMobNumberFunc(e.target.value)}/>
            </div>
            <div className="fr2_div4">
              <button className="fr2_button" onClick={(e)=>{navigate("/dash") }}>Register Free</button>
            </div>
          </div>
          <div className="fr2_div5">
          <label className="fr2_l3">
              By clicking on Register Free, you agree   
            </label><label className="f2_label1">to Terms & Conditions</label>
            <label>and</label>
            <label className="f2_label1">Privacy Policy</label>          </div>
        </div>
      </div>
      <div className="fr3">
        <ul>
